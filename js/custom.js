...
function slide2() {
    console.log("slideFunction");
    let slidesToShow2 = 2; // Default for small screens
    ...
    let totalSlides2 = Slides1.length;
    ...
    Sliders2.forEach(function (slider2) {
        ...
        slideWidth2 = slideContainerWidth2 / slidesToShow2; // Calculate correct slide width
